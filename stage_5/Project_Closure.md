...
|-----------|-------------|-----------------|--------|
| **Better time management** | Medium | Allocate less time for testing simple features | Time savings at the start of the project |
| **Stay focused on current feature** | Medium | Enforce respect of the chosen commit strategy | More structured workflow |
